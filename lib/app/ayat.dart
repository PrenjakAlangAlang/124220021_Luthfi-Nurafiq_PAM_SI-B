...
class _SurahDetailPageState extends State<SurahDetailPage> {
  ...
  UserModel? user; // Declare user variable
  ...
  // Contoh penggunaan di method toggleBookmark
      ...
      setState(() {
        if (user!.bookmarks.contains(ayatReference)) {
          ...
          NotificationService().showInstantNotification(
            'Bookmark Dihapus',
            'Ayat telah dihapus dari bookmark',
          );
        } else {
          user!.bookmarks.add(ayatReference);
          NotificationService().showInstantNotification(
            'Bookmark Ditambahkan',
            'Ayat telah ditandai terakhir dibaca',
          );
        }
      });
      await user!.save();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        flexibleSpace: Align(
          alignment: Alignment(0,
              0.5), // Menempatkan teks di tengah secara horizontal dan sedikit ke bawah
          child: const Text(
            'Surah',
            style: TextStyle(
      ...
      body: isLoading
          ...
          : Column(
              children: [
                // Surah information header if needed
                Row(
