...
import 'package:quran/app/saran.dart';
...
class _HomeState extends State<Home> {
    ...
    switch (index) {
      ...
      case 1:
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(builder: (context) => const Saran()),
        );
        break;
      case 2:
        Navigator.pushReplacement(
  ...
  void _showMenu(String value) {
    switch (value) {
      case 'Ayat Terakhir Dibaca':
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => TerakhirDibaca()));
        break;
      case 'Edit Profil':
          ...
          children: [
            ...
            PopupMenuButton<String>(
              ...
              itemBuilder: (BuildContext context) {
                return {'Ayat Terakhir Dibaca', 'Edit Profil'}
                    .map((String choice) {
